...
// FIX: Resolved framer-motion's `children` prop type conflict with React.forwardRef by not destructuring props in the function signature.
const DialogContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentPropsWithoutRef<typeof motion.div>
>((props, ref) => {
  // FIX: Do not destructure children from props to avoid type conflicts with forwardRef.
  // Pass children to motion.div implicitly via {...rest}.
  ...
  return (
    <motion.div
      ...
      {...rest}
    >
      {/* children is passed through the 'rest' spread above */}
